...
export default function HomeScreen({ onNavigate }) {
  ...
  const handleKioskPasswordSubmit = () => {
    if (!kioskPassword.trim()) {
      setKioskPasswordError('Informe a senha.');
      return false;
    }

    if (kioskPassword !== '1234') {
      setKioskPasswordError('Senha incorreta.');
      return false;
    }
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContainer, styles.kioskPasswordContainer]}>
            ...
            <View style={styles.kioskFunctionsContainer}>
              ...
              <View style={styles.kioskFunctionsRow}>
                <Pressable
                  style={[styles.kioskFunctionItem, styles.kioskFunctionItemHalf, kioskFunctions.openTable && styles.kioskFunctionActive]}
                ...
                <Pressable
                  style={[styles.kioskFunctionItem, styles.kioskFunctionItemHalf, kioskFunctions.openTables && styles.kioskFunctionActive]}
              ...
              <View style={styles.kioskFunctionsRow}>
                <Pressable
                  style={[styles.kioskFunctionItem, styles.kioskFunctionItemHalf, kioskFunctions.buyChips && styles.kioskFunctionActive]}
                ...
                <Pressable
                  style={[styles.kioskFunctionItem, styles.kioskFunctionItemHalf, kioskFunctions.reserve && styles.kioskFunctionActive]}
              ...
              <View style={styles.kioskFunctionsRow}>
                <Pressable
                  style={[styles.kioskFunctionItem, styles.kioskFunctionItemHalf, kioskFunctions.consumption && styles.kioskFunctionActive]}
            ...
            <View style={styles.modalActions}>
              ...
              <Pressable style={[styles.modalButton, styles.modalButtonPrimary]} onPress={() => {
                const isValidPassword = handleKioskPasswordSubmit();
                if (!isValidPassword) {
                  return;
                }
